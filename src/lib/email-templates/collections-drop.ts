...
export function renderCollectionsDropEmail(
  ...
  const copy =
    current === "es"
      ? {
          subject: "10 colecciones nuevas en AgentPets. Descubre la tuya",
          intro:
      ...
      : current === "zh"
        ? {
            subject: "AgentPets 推出 10 个全新合集，看看你的宠物属于哪一个",
            intro:
              "我们把所有宠物归入了 10 个有故事感的合集。你的宠物已经在其中一个里了。",
            cta: "查看我的合集",
          }
        : {
            subject: "10 fresh collections on AgentPets. Find yours",
            intro:
