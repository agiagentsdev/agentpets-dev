...
export function renderSubmissionRejectedEmail(
  ...
  const copy =
    current === "es"
      ? {
          subject: `Tu envío a AgentPets necesita cambios: ${vars.petName}`,
